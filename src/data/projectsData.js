export const projectsData = [
  ...
  },
  {
    ...
    links: [
      ...
      { url: "https://github.com/comnsense/reactTarot", icon: "fab fa-github", text: "GitHub" }
    ]
  },
  {
    ...
    skills: ["Next.js", "Strapi", "REST API", "TypeScript"],
    description: "EComm-CS is an online store created as a portfolio project. Uses Next.js for frontend and Strapi for backend. Deployed on Vercel.",
    links: [
      { url: "https://e-comm-cs.vercel.app", icon: "fas fa-external-link-alt", text: "Demo" },
      { url: "https://github.com/comnsense/EComm-CS", icon: "fab fa-github", text: "GitHub" }
    ]
  },
  {
  ...
  },
  {
    ...
    image: "/img/tic-tac-toe.gif",
    fallbackIcon: "fa-gamepad",
    skills: ["HTML5", "CSS3", "JavaScript"],
    links: [
      { url: "https://comnsense.github.io/Tic-Tac-Toe-Game", icon: "fas fa-external-link-alt", text: "Demo" },
      { url: "https://github.com/comnsense/Tic-Tac-Toe-Game", icon: "fab fa-github", text: "GitHub" }
    ]
  },
  {
    title: "Halloween Website",
    image: "/img/HelloweenApp.jpg",
    fallbackIcon: "fa-pumpkin",
    skills: ["HTML5", "CSS3", "Responsive"],
    description: "Web-Design project with thematic design.",
    links: [
      { url: "https://comnsense.github.io/Projects/Halloween%20Website", icon: "fas fa-external-link-alt", text: "Demo" },
      { url: "https://github.com/comnsense/Projects/tree/main/Halloween%20Website", icon: "fab fa-github", text: "GitHub" }
    ]
  },
  {
    title: "Blog Theme - MumblrTum",
    image: "/img/tumblr-theme.jpeg",
    fallbackIcon: "fa-blog",
    skills: ["HTML5", "CSS3", "JavaScript"],
    description: "Custom blog theme",
    links: [
      { url: "https://mumblrtum.tumblr.com/", icon: "fas fa-external-link-alt", text: "Overview" },
  ...
  },
  {
    ...
    details: [
      "Manage members, customers, and payments for services",
      "Process optimization through data visualization"
    ],
    links: [
